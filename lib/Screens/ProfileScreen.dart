        ...
        children: [
          ...
          Positioned(
              ...
              child: IconButton(
                ...
                icon: const Icon(Icons.menu,size: 48,color: kMainColor) ,
              )),
          ...
          Positioned(top:80,right:100  ,child: Column(
            children: [
              ...
              Container(
                margin: const EdgeInsets.only(top: 33,bottom:7 ),
                child: const Text("Joanna Lee",style: TextStyle(fontSize: 48,fontFamily: "Lobster",color: kMainColor ),),

              ),

              const Text("joanna.lee@youremail.com",style: TextStyle(fontSize:14,color: kMainColor ),),
                  ...
                  Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text("#23VF40CCE9a",style: TextStyle(fontSize: 14,color: kMainColor),),
